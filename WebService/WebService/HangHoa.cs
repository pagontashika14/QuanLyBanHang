...
namespace WebService
{
    public class HangHoa
    {
        ...
        public decimal khuyen_mai_hien_tai
        {
            get
            {
                using (var context = new TKHTQuanLyBanHangEntities())
        ...
        public List<KhuyenMai> khuyen_mai
        {
            get
            {
    ...
    {
        GD_KHUYEN_MAI khuyenMai;
        public KhuyenMai(GD_KHUYEN_MAI km)
        {
            khuyenMai = km;
        }
        public decimal id { get { return khuyenMai.ID; } }
    }
